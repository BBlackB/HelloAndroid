...
public class UDPBroadcast {
    ...
    private static final int RESPONSE_DEVICE_MAX = 10;
   ...
   public List<LightDevice> Send(byte[] data) throws IOException {
    ...
    public List<LightDevice> Send() throws IOException {
        ...
        DatagramPacket datagramPacket = new DatagramPacket(sendData, sendData.length,getBroadcastAddress(), serverPort);
